...
void update_buffer_objects()
{
  ...
  if(g_mesh_model==kAvocado && g_mesh_type==kTriangleSoup){
  ...
  if(g_mesh_model==kDonut && g_mesh_type==kTriangleSoup){
  ...
  // IBO
  if(g_mesh_type==kVlistTriangles && g_mesh_model==kCube){
  ...
  if(g_mesh_type==kVlistTriangles && g_mesh_model==kAvocado){
  ...
  if(g_mesh_type==kVlistTriangles && g_mesh_model==kDonut){
