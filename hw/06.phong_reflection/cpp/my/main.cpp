...
void init_shader_program()
{
  ...
  // TODO: GPU의 uniform/attribute 변수들의 위치를 가져옵니다.
  // Phong 반사 모델을 구현하기 위해 필요한 변수들입니다.
...
void render_object()
{
  ...
  for (std::size_t i = 0; i < g_models.size(); ++i)
  {
    ...
    // Set mat_model, mat_normal, mat_PVM
    ...
    // Send uniform data for model to GPU
