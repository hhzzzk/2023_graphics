...
void set_transform() 
{
  ...
  // glm::mat3 rot3x3 = glm::mat3_cast(q);
  glm::mat4 rot4x4 = glm::mat4_cast(q);
  g_mat_model = glm::translate(g_vec_model_translate);
  g_mat_model *= rot4x4;
  g_mat_model *= glm::scale(glm::mat4(1.0f),g_vec_model_scale);
}
...
void init_scene()
{
  ...
  g_quat_model_rotation = glm::quat(0.f, 0.f, 0.f, 0.f);
